...
Gem::Specification.new do |spec|
  ...
  # 2.7 is the floor for the public gem. Everything is written to also run on
  # 2.6, which is the system Ruby on macOS and therefore what a first-time
  # user is most likely to have.
